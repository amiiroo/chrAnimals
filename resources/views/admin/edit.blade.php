                ...
                <div class="form-col">
                    <div class="form-group">
                        ...
                        <select id="kind" name="kind" required>
                            <option value="animal" {{ old('kind', $card->kind) == 'animal' ? 'selected' : '' }}>Животное</option>
                            <option value="plants" {{ old('kind', $card->kind) == 'plants' ? 'selected' : '' }}>Растение</option>
                            <option value="bug" {{ old('kind', $card->kind) == 'bug' ? 'selected' : '' }}>Насекомое</option>
                            <option value="fungus" {{ old('kind', $card->kind) == 'fungus' ? 'selected' : '' }}>Гриб</option>
                        </select>
                        @error('kind')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
